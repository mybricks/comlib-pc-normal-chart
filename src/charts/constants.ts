...
//   ],
//   array: [{ v: 'color', l: '颜色' }],
//   function: [{ v: 'tooltip.formatter', l: '自定义提示信息' }],
// };
...
export const inputSchemaMap = {
  ...
  // [inputIdMap.TOOLTIP_FORMATTER]: { title: '悬浮提示内容格式化', schema: { type: 'string' } },
}
...
export const inputConfigMap = {
  ...
  // [inputIdMap.TOOLTIP_FORMATTER]: [chartTypes.LINE, chartTypes.COLUMN, chartTypes.BAR, chartTypes.PIE],
}
